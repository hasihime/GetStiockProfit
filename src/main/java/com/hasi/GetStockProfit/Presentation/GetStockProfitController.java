...
public class GetStockProfitController {
    ...
    public String GetInterStockProfit(@RequestBody KakaoSkillResponseRequest kakaoChatbotResponse) throws Exception{
        return  interService.GetmaxProfit(kakaoChatbotResponse);
    }
