...
@SpringBootTest
class CalculationProfitServiceTest {
    ...
    public void alwaysUpword() {
        ...
        Profit result = calculationProfitService.calculateProfit("testticker",test);
    ...
    @DisplayName("전체")
    public void allarr() {
        Profit result = calculationProfitService.calculateProfit("testticker",testDataarr);
        assertEquals(8f, result.getMaxprofit());
        assertEquals("2020-09-06", result.getLowdate());
        assertEquals("2020-09-08", result.getHighdate());
    }
